					...
					<div className="pt-0 grid gap-4">
						<div className="grid grid-cols-2 gap-6">
							<Button variant="outline" onClick={() => signIn('github', { callbackUrl: '/' })}>
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="mr-2 h-4 w-4 text-black" viewBox="0 0 16 16">
						...
						<form onSubmit={handleSubmit}>
							...
							<div className="grid gap-2 mt-2">
								<div className="sm:mb-4 mb-3 relative grid gap-2">
									...
									<button type="button" onClick={handleTogglePassword} className="absolute inset-y-0 h-10 mt-[1.40rem] right-0 pr-3 flex items-center text-gray-500">
							...
							<div className="flex flex-col items-center pt-5">
								...
								<div className="flex gap-1 text-sm text-muted-foreground mt-2">
									...
									<Link href={`/auth/signup?callbackUrl=${searchParams.get('callbackUrl') || '/'}`} className="underline">
										Sign up
									</Link>
								</div>
							</div>
